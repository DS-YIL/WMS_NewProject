...
import { materialreserveMain, materialRequestDetails, materialListforReserve, materialReservetorequestModel, materialResFilterParams,gatepassModel, materialistModel, materialList, requestData } from 'src/app/Models/WMS.Model';
import { MessageService } from 'primeng/api';
import { DatePipe } from '@angular/common';

@Component({
  selector: 'app-MaterialReserveDashboard',
  templateUrl: './MaterialReserveDashboard.component.html'
})
export class MaterialReserveDashboardComponent implements OnInit {
  ...
  public requestList: materialreserveMain[] = [];
  ...
  getMaterialRequestlist() {
    ...
    this.spinner.show();
    this.wmsService.getMaterialReserveDashboardlist(this.materialResFilterParams).subscribe(data => {
      this.spinner.hide();
  ...
  showattachdata(rowData: materialreserveMain) {
