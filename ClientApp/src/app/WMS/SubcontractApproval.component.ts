...
@Component({
  selector: 'app-SubcontractApproval',
  templateUrl: './SubcontractApproval.component.html'
})
export class SubcontractApprovalComponent implements OnInit {
  ...
  getMaterialRequestlist(employeeno) {
    debugger;
    this.wmsService.getrequestdataforSTOapproval(employeeno,'SubContract').subscribe(data => {
