...
@Component({
  selector: 'app-InitialStockLoad',
  templateUrl: './InitialStockLoad.component.html',
  providers: [ConfirmationService]
})
export class InitialStockLoadComponent implements OnInit {
  ...
  getMainlist() {
    ...
    this.viewexception = false;
    this.spinner.show();
    this.wmsService.getinitialStockLoad().subscribe(data => {
